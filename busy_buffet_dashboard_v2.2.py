...
โดยใช้ข้อมูลจริงพิสูจน์ว่าแต่ละข้อเป็นความจริงหรือไม่
""")
...
• Queue มีผลต่อทั้งสองกลุ่ม และนำไปสู่การสูญเสียรายได้<br>
...
• ถ้าไม่จัดการให้เป็นระบบ อาจทำให้ staff มีอาการเหนื่อยสะสม และระบบไม่ยั่งยืน
</div>
""", unsafe_allow_html=True)
...
st.subheader("Comment 3: Walk-In นั่งทั้งวัน ทำให้หาที่นั่งให้ In-House ไม่ได้")
...
• แต่ลูกค้าส่วนใหญ่ยังอยู่ในช่วงเวลาที่ร้านกำหนด ไม่ได้นั่งนานผิดปกติ<br><br>

<strong>So what?</strong><br>
• ปัญหาหลักไม่ได้อยู่ที่ ลูกค้านั่งนาน แต่คือ ลูกค้าเข้ามาในช่วงเวลาเดียวกันมากเกินไป<br>
• ดังนั้น ถ้าแก้แค่เรื่องลดเวลานั่ง อาจไม่ช่วยแก้ปัญหาได้จริงทั้งหมด
</div>
""", unsafe_allow_html=True)
...
<strong>Interpretation:</strong><br>
• ปัญหาไม่ได้อยู่ที่ ลูกค้านั่งนาน แต่เป็นช่วง peak ที่ลูกค้าเข้ามาพร้อมกันเยอะ<br><br>

<strong>So what?</strong><br>
• การตั้ง time limit อาจไม่ได้ช่วยเพิ่มการหมุนโต๊ะมากนัก<br>
• อาจทำให้ลูกค้าที่กินตามระยะเวลาที่กำหนดปกติรู้สึกไม่ดี และกระทบ experience โดยไม่จำเป็น
</div>
""", unsafe_allow_html=True)
...
<strong>So what?</strong><br>
• การข้ามคิวอาจเหมือนเป็นการเปลี่ยนคนรอจาก In-House → Walk-In ซึ่งอาจเกิดปัญหาการเดินหนีไปเพิ่มมากขึ้น<br>
...
• พิจารณาลดเวลาใช้โต๊ะลงเล็กน้อย ให้สอดคล้องกับพฤติกรรมลูกค้า<br><br>
